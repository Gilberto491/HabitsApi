...
INSERT INTO habit_templates (id, category_id, name, description, default_weekly_target, difficulty, base_points) VALUES
                                                                                                                     ('aaa11111-1111-1111-1111-111111111111','11111111-1111-1111-1111-111111111111','Treinar musculação','Treino de força',3,'NORMAL',10),
                                                                                                                     ...
                                                                                                                     ('bbb22222-2222-2222-2222-222222222222','22222222-2222-2222-2222-222222222222','Ler 20 min','Leitura focada',5,'NORMAL',10),
                                                                                                                     ('ccc33333-3333-3333-3333-333333333331','33333333-3333-3333-3333-333333333333','Beber 2L de água','Hidratação diária',7,'EASY',6),
                                                                                                                     ('ccc33333-3333-3333-3333-333333333332','33333333-3333-3333-3333-333333333333','Dormir >=7h','Higiene do sono',5,'NORMAL',10),
                                                                                                                     ...
                                                                                                                     ('eee55555-5555-5555-5555-555555555552','55555555-5555-5555-5555-555555555555','Tempo com a família','Qualidade > quantidade',3,'NORMAL',10)
ON CONFLICT (id) DO NOTHING;
